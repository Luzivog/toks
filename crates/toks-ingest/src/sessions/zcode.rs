...
use super::utils::{
    back_anchor_timestamp, estimate_tokens, file_modified_timestamp_ms, lossy_lines,
    open_readonly_sqlite, parse_timestamp_str, session_id_from_path,
};
...
/// `output_tokens` already contains `reasoning_tokens`. Toks's
