//! Tokscope rendering, organized around the user-facing sections rather than
...
pub fn detail(app: &TokscopeApp, cx: &mut gpui::Context<TokscopeApp>) -> impl IntoElement {
    pages::detail(app, cx)
}
