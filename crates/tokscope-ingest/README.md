...
runtime state is namespaced under Tokscope and it has no Tokscale installation,
process, repository, or cache dependency.

The parser foundation was originally derived from Tokscale v4.13.0
(`94a02774`) under the MIT license. Tokscope now owns this fork and its product
