...
#[path = "ui_interactions/account_row_interactions.rs"]
mod account_row_interactions;
...
#[path = "ui_interactions/remote_control_interactions.rs"]
mod remote_control_interactions;
#[path = "ui_interactions/resize_edge_interactions.rs"]
