...
use toks_core::history::{HistoryStatus, HistoryView, LocalHistory};
...
fn should_publish(
    current: Option<&toks_core::HistorySnapshot>,
    candidate: &toks_core::HistorySnapshot,
) -> bool {
