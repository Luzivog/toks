...
use super::{read_auth, CredentialError};

const HELPER_ENV: &str = "TOKS_TEST_CODEX_REFRESH_HELPER";
const HELPER_TEST: &str = "codex_router::credentials::refresh_tests::refresh_process_helper";
...
fn refresh_process_helper() {
    ...
    let runtime = tokio::runtime::Builder::new_current_thread()
        ...
        .build()
        .unwrap();
    let result = runtime.block_on(super::refresh::refresh_at(&path, &auth, &endpoint));
